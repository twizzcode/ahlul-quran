  ...
  return (
    <div className="pb-16 pt-[calc(var(--home-nav-height)+1rem)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section id="arah-program" className="scroll-mt-28 py-14">
          <SectionHeading
        ...
        <section id="aktivasi-awal" className="scroll-mt-28 py-14">
          <SectionHeading
        ...
        <section id="penggerak-program" className="scroll-mt-28 py-14">
          <SectionHeading

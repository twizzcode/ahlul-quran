...
export const DEFAULT_MASJID_PROFILE: MasjidProfileData = {
  ...
  homepageTestimonials: [
    {
      quote:
        "Programnya terasa dekat dan terarah. Kami jadi lebih mudah ikut ambil bagian dalam pembangunan masjid dan kegiatan dakwah.",
      name: "Ahmad Fauzi",
      role: "Jamaah Rutin",
      imageUrl: "/logo.webp",
      socialPlatform: "",
    ...
    {
      quote:
        "Informasi donasi dan kabar program tersaji jelas. Rasanya lebih tenang ketika ingin menitipkan amanah untuk gerakan umat.",
      name: "Siti Rahma",
      role: "Donatur",
      imageUrl: "/logo.webp",
      socialPlatform: "",
    ...
    {
      quote:
        "Masjid ini bukan hanya tempat ibadah, tapi juga ruang tumbuh yang menghubungkan kajian, sosial, dan kepedulian warga.",
      name: "Budi Santoso",
    ...
    {
      quote:
        "Dengan tampilan yang lebih rapi, update kegiatan dan kebutuhan pembangunan jadi jauh lebih mudah dipahami oleh jamaah.",
      name: "Nabila Azzahra",
